...
/*package*/ class Model_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new subjectListHandler_pyq9q9_c3a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_subject");
    Style style = new StyleImpl();
  ...
  private static class subjectListHandler_pyq9q9_c3a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public subjectListHandler_pyq9q9_c3a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.subject$Pb$g;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Subject$CE;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(subjectListHandler_pyq9q9_c3a.this.getNode(), LINKS.subject$Pb$g));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Subject$CE = MetaAdapterFactory.getConcept(0x93a85216feee47faL, 0xa39e2320d26e7cceL, 0x214447fe61929cbbL, "EDOM.structure.Subject");
  }
