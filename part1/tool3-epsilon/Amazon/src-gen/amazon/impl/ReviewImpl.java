...
public class ReviewImpl extends ReviewCommentImpl implements Review {
	...
	public void setMaxInterval(int newMaxInterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmazonPackage.REVIEW__MAX_INTERVAL, oldMaxInterval,
					maxInterval));
	}
	...
	public void setMinInterval(int newMinInterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmazonPackage.REVIEW__MIN_INTERVAL, oldMinInterval,
					minInterval));
	}
