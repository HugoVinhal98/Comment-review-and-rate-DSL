...
/**
 * This is the item provider adapter for a {@link amazon.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider extends ReviewCommentItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_reply_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_reply_feature", "_UI_Comment_type"),
				 AmazonPackage.Literals.COMMENT__REPLY,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmazonPackage.Literals.COMMENT__PROCESS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmazonPackage.Literals.COMMENT__PROCESS,
				 AmazonFactory.eINSTANCE.createProcess()));
	}
