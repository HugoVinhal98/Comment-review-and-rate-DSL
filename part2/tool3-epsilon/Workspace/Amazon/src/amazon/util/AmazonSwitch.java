 ...
 * @generated
 */
public class AmazonSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AmazonPackage.REVIEW_COMMENT: {
			...
			case AmazonPackage.REVIEW: {
				...
				if (result == null) result = caseReviewComment(review);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AmazonPackage.COMMENT: {
				...
				if (result == null) result = caseReviewComment(comment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AmazonPackage.PROCESS: {
				amazon.Process process = (amazon.Process)theEObject;
				T result = caseProcess(process);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AmazonPackage.NODE: {
			...
			case AmazonPackage.AUTOMATIC: {
				Automatic automatic = (Automatic)theEObject;
				T result = caseAutomatic(automatic);
				if (result == null) result = caseNode(automatic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AmazonPackage.MANUAL: {
				...
				if (result == null) result = caseNode(manual);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseProcess(amazon.Process object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Automatic</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Automatic</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAutomatic(Automatic object) {
		return null;
	}
