...
public interface AmazonPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link amazon.IsAccepted <em>Is Accepted</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see amazon.IsAccepted
	 * @see amazon.impl.AmazonPackageImpl#getIsAccepted()
	 * @generated
	 */
	int IS_ACCEPTED = 12;

	/**
	 * The meta object id for the '{@link amazon.FieldType <em>Field Type</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see amazon.FieldType
	 * @see amazon.impl.AmazonPackageImpl#getFieldType()
	 * @generated
	 */
	int FIELD_TYPE = 13;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link amazon.User#getField <em>Field</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Field</em>'.
	 * @see amazon.User#getField()
	 * @see #getUser()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link amazon.Node#getIsAccepted <em>Is Accepted</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Is Accepted</em>'.
	 * @see amazon.Node#getIsAccepted()
	 * @see #getNode()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for enum '{@link amazon.IsAccepted <em>Is Accepted</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for enum '<em>Is Accepted</em>'.
	 * @see amazon.IsAccepted
	 * @generated
	 */
	EEnum getIsAccepted();
	...
	/**
	 * Returns the meta object for enum '{@link amazon.FieldType <em>Field Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link amazon.IsAccepted <em>Is Accepted</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see amazon.IsAccepted
		 * @see amazon.impl.AmazonPackageImpl#getIsAccepted()
		 * @generated
		 */
		EEnum IS_ACCEPTED = eINSTANCE.getIsAccepted();

		/**
		 * The meta object literal for the '{@link amazon.FieldType <em>Field Type</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see amazon.FieldType
		 * @see amazon.impl.AmazonPackageImpl#getFieldType()
