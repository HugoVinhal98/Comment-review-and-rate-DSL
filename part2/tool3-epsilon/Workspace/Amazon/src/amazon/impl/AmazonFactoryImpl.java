...
public class AmazonFactoryImpl extends EFactoryImpl implements AmazonFactory {
	...
	public static AmazonFactory init() {
		try {
			AmazonFactory theAmazonFactory = (AmazonFactory)EPackage.Registry.INSTANCE.getEFactory(AmazonPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case AmazonPackage.MODEL: return createModel();
			case AmazonPackage.SUBJECT: return createSubject();
			case AmazonPackage.FIELD: return createField();
			case AmazonPackage.USER: return createUser();
			case AmazonPackage.REVIEW: return createReview();
			case AmazonPackage.COMMENT: return createComment();
			case AmazonPackage.PROCESS: return createProcess();
			case AmazonPackage.AUTOMATIC: return createAutomatic();
			case AmazonPackage.MANUAL: return createManual();
			case AmazonPackage.GRADE: return createGrade();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case AmazonPackage.IS_ACCEPTED:
				return createIsAcceptedFromString(eDataType, initialValue);
			case AmazonPackage.FIELD_TYPE:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case AmazonPackage.IS_ACCEPTED:
				return convertIsAcceptedToString(eDataType, instanceValue);
			case AmazonPackage.FIELD_TYPE:
	 ...
	 * @generated
	 */
	public IsAccepted createIsAcceptedFromString(EDataType eDataType, String initialValue) {
		IsAccepted result = IsAccepted.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertIsAcceptedToString(EDataType eDataType, Object instanceValue) {
