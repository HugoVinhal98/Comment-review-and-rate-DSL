 ...
 * @generated
 */
public class UserName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UserName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AmazonParserProvider.getParser(AmazonElementTypes.User_3009, getParserElement(),
					AmazonVisualIDRegistry.getType(amazon.diagram.edit.parts.UserName2EditPart.VISUAL_ID));
		}
		return parser;
	}
