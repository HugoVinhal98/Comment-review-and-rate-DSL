...
import amazon.diagram.edit.policies.Field3ItemSemanticEditPolicy;
...
public class Field3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FieldName3EditPart) {
			((FieldName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureFieldLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AmazonVisualIDRegistry.getType(FieldName3EditPart.VISUAL_ID));
	}
	...
	public class FieldFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureFieldLabelFigure;
		...
		private void createContents() {
			...
			fFigureFieldLabelFigure = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureFieldLabelFigure() {
			return fFigureFieldLabelFigure;
		}
	...
	* @generated
	*/
	static final Color THIS_BACK = new Color(null, 255, 255, 51);
