...
import amazon.diagram.edit.commands.AmazonCreateShortcutDecorationsCommand;
import amazon.diagram.edit.policies.ModelCanonicalEditPolicy;
import amazon.diagram.edit.policies.ModelItemSemanticEditPolicy;
...
public class ModelEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Amazon"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command
							.chain(new ICommandProxy(new AmazonCreateShortcutDecorationsCommand(getEditingDomain(),
