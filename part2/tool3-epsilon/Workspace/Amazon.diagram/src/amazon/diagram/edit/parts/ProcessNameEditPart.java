 ...
 * @generated
 */
public class ProcessNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AmazonParserProvider.getParser(AmazonElementTypes.Process_3006, getParserElement(),
					AmazonVisualIDRegistry.getType(amazon.diagram.edit.parts.ProcessNameEditPart.VISUAL_ID));
		}
		return parser;
	}
