 ...
 * @generated
 */
public class GradeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GradeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AmazonParserProvider.getParser(AmazonElementTypes.Grade_3004, getParserElement(),
					AmazonVisualIDRegistry.getType(amazon.diagram.edit.parts.GradeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
