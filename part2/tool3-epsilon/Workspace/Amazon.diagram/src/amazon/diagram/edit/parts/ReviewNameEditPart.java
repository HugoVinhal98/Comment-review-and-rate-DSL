 ...
 * @generated
 */
public class ReviewNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ReviewNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AmazonParserProvider.getParser(AmazonElementTypes.Review_3001, getParserElement(),
					AmazonVisualIDRegistry.getType(amazon.diagram.edit.parts.ReviewNameEditPart.VISUAL_ID));
		}
		return parser;
	}
