 ...
 * @generated
 */
public class ReviewItemSemanticEditPolicy extends AmazonBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ReviewItemSemanticEditPolicy() {
	...
	*/
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (AmazonVisualIDRegistry.getVisualID(node)) {
			case ReviewReviewAttributeCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (AmazonVisualIDRegistry.getVisualID(cnode)) {
