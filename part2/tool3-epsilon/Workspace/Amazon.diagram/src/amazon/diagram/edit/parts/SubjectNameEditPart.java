...
public class SubjectNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AmazonParserProvider.getParser(AmazonElementTypes.Subject_2001, getParserElement(),
					AmazonVisualIDRegistry.getType(amazon.diagram.edit.parts.SubjectNameEditPart.VISUAL_ID));
		}
		return parser;
	}
