 ...
 * @generated
 */
public class ManualNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ManualNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AmazonParserProvider.getParser(AmazonElementTypes.Manual_3008, getParserElement(),
					AmazonVisualIDRegistry.getType(amazon.diagram.edit.parts.ManualNameEditPart.VISUAL_ID));
		}
		return parser;
	}
