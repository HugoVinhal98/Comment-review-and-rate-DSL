 ...
 * @generated
 */
public class UserNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AmazonParserProvider.getParser(AmazonElementTypes.User_3003, getParserElement(),
					AmazonVisualIDRegistry.getType(amazon.diagram.edit.parts.UserNameEditPart.VISUAL_ID));
		}
		return parser;
	}
