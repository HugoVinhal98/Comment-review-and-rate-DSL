 ...
 * @generated
 */
public class FieldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FieldNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AmazonParserProvider.getParser(AmazonElementTypes.Field_3002, getParserElement(),
					AmazonVisualIDRegistry.getType(amazon.diagram.edit.parts.FieldNameEditPart.VISUAL_ID));
		}
		return parser;
	}
