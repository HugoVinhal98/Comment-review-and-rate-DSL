...
import amazon.diagram.edit.policies.AmazonTextSelectionEditPolicy;
 ...
 * @generated
 */
public class AutomaticNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AutomaticNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new AmazonTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return AmazonElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AmazonParserProvider.getParser(AmazonElementTypes.Automatic_3007, getParserElement(),
					AmazonVisualIDRegistry.getType(amazon.diagram.edit.parts.AutomaticNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, AmazonEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
