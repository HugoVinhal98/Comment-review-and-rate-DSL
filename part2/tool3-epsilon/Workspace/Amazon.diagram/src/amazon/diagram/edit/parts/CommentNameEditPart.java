 ...
 * @generated
 */
public class CommentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CommentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AmazonParserProvider.getParser(AmazonElementTypes.Comment_3005, getParserElement(),
					AmazonVisualIDRegistry.getType(amazon.diagram.edit.parts.CommentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
