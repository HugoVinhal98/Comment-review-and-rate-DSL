...
namespace isep.edom.gorgeous
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.gorgeousEditorFactoryId)]
	internal partial class gorgeousEditorFactory : gorgeousEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new gorgeousEditorFactory.
		/// </summary>
		public gorgeousEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class gorgeousEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected gorgeousEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new gorgeousDocData(this.ServiceProvider, typeof(gorgeousEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new gorgeousDocView(docData, this.ServiceProvider);
		}
	}
}
