...
namespace isep.edom.gorgeous
{
	...
	/// </summary>
	internal partial class gorgeousDocData : gorgeousDocDataBase
	{
		/// <summary>
	...
	/// <summary>
	/// Class which represents a gorgeous document in memory.
	/// </summary>
	internal abstract partial class gorgeousDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		protected override string FormatList
		{
			get
			{
				return global::isep.edom.gorgeous.gorgeousDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::isep.edom.gorgeous.gorgeousDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::isep.edom.gorgeous.gorgeousDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::isep.edom.gorgeous.gorgeousDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::isep.edom.gorgeous.Model modelRoot = null;
			...
			global::isep.edom.gorgeous.gorgeousDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::isep.edom.gorgeous.gorgeousSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::isep.edom.gorgeous.gorgeousDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::isep.edom.gorgeous.gorgeousDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected override string SerializedModel
		{
			get
			{
				global::isep.edom.gorgeous.Model modelRoot = this.RootElement as global::isep.edom.gorgeous.Model;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::isep.edom.gorgeous.gorgeousSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
