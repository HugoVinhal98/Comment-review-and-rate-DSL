...
namespace isep.edom.gorgeous
{
	...
	/// </summary>
	internal partial class gorgeousExplorer : gorgeousExplorerBase
	{
		/// <summary>
		/// Constructs a new gorgeousExplorer.
		/// </summary>
		public gorgeousExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the gorgeousExplorerToolWindow.
	/// </summary>
	internal abstract class gorgeousExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new gorgeousExplorerBase.
		/// </summary>
		protected gorgeousExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.gorgeousExplorerMenu;
			}
		}
		...
		{
			get { return global::isep.edom.gorgeous.Model.DomainClassId; }
		}
