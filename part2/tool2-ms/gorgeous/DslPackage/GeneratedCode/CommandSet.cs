...
namespace isep.edom.gorgeous
{
	...
	/// </summary>
	internal partial class gorgeousCommandSet : gorgeousCommandSetBase
	{
		/// <summary>
		/// Constructs a new gorgeousCommandSet.
		/// </summary>
		public gorgeousCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class gorgeousCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new gorgeousCommandSetBase.
		/// </summary>
		protected gorgeousCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewgorgeousExplorerCommand,
				typeof(gorgeousEditorFactory).GUID);
		...
		{
			gorgeousExplorerToolWindow explorer = this.gorgeousExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected gorgeousDocData CurrentgorgeousDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as gorgeousDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected gorgeousDocView CurrentgorgeousDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as gorgeousDocView;
			}
		}
		...
		/// </summary>
		protected gorgeousExplorerToolWindow gorgeousExplorerToolWindow
		{
			get
			{
				gorgeousExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(gorgeousExplorerToolWindow), true) as gorgeousExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				gorgeousExplorerToolWindow explorerWindow = this.gorgeousExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class gorgeousClipboardCommandSet : gorgeousClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new gorgeousClipboardCommandSet.
		/// </summary>
		public gorgeousClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class gorgeousClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new gorgeousClipboardCommandSetBase.
		/// </summary>
		protected gorgeousClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
