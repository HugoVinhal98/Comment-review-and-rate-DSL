...
namespace isep.edom.gorgeous
{
	...
	/// </summary>
	internal partial class gorgeousDocView : gorgeousDocViewBase
	{
		/// <summary>
		/// Constructs a new gorgeousDocView.
		/// </summary>
		public gorgeousDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class gorgeousDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new gorgeousDocView.
		/// </summary>
		protected gorgeousDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			gorgeousDocDataBase docData = this.DocData as gorgeousDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for gorgeousDocViewBase should be an gorgeousDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::isep.edom.gorgeous.gorgeousDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::isep.edom.gorgeous.gorgeousDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::isep.edom.gorgeous.gorgeousToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::isep.edom.gorgeous.gorgeousToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.gorgeousDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::isep.edom.gorgeous.gorgeousHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::isep.edom.gorgeous.gorgeousHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::isep.edom.gorgeous.gorgeousHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
