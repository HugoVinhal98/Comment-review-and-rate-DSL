...
namespace isep.edom.gorgeous
{
	...
	/// </remarks>
	public partial class gorgeousHelpKeywordHelper : gorgeousHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new gorgeousHelpKeywordHelper.
		/// </summary>
		protected gorgeousHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the gorgeousHelpKeywordHelper.
		/// </summary>
		public static gorgeousHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class gorgeousHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new gorgeousHelpKeywordHelperBase.
		/// </summary>
		protected gorgeousHelpKeywordHelperBase()
			: base() { }
